...
with tab1:
    ...
    with col1:
        lang_selections['EN'] = st.checkbox('English', value=True)
        lang_selections['DE'] = st.checkbox('German', value=True)
        lang_selections['FR'] = st.checkbox('French', value=True)
        lang_selections['ES'] = st.checkbox('Spanish', value=True)
    
    with col2:
        lang_selections['PT'] = st.checkbox('Portuguese', value=True)
        lang_selections['IT'] = st.checkbox('Italian', value=True)
        lang_selections['CZ'] = st.checkbox('Czech', value=True)
        lang_selections['PL'] = st.checkbox('Polish', value=True)
    
    with col3:
        lang_selections['TK'] = st.checkbox('Turkish', value=True)
        lang_selections['VI'] = st.checkbox('Vietnamese', value=True)
        lang_selections['TH'] = st.checkbox('Thai', value=True)
        lang_selections['ID'] = st.checkbox('Indonesian', value=True)
    
    with col4:
        lang_selections['KO'] = st.checkbox('Korean', value=True)
        lang_selections['CN'] = st.checkbox('Chinese (CN)', value=True)
        lang_selections['TW'] = st.checkbox('Chinese (TW)', value=True)
        lang_selections['MX'] = st.checkbox('Spanish (MX)', value=True)
